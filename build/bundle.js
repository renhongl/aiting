	...
	var AiTing = function () {
	    ...
	    _createClass(AiTing, [{
	        ...
	        value: function _loadTemplate() {
	            ...
	            _Ajax2.default.load('../app/module/aiting/view.html').then(function (result) {
	                (0, _jquery2.default)('#container').html(result);
	                (0, _jquery2.default)('#content').height((0, _jquery2.default)('#container').height() - 100);
	                _this._createVueApp();
	            });
	        }
	    }, {
